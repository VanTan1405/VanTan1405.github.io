...
<div class="inner-header">
    <div class="container">
        <div class="pull-left">
            <h6 class="inner-title" style="font-family: bold; color: #f90">Sản phẩm {{$sanpham->name}}</h6>
        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="single-item">
                                ...
                                <div class="single-item-caption" style="margin-top: 12px; margin-bottom: 20px">
                                    <a class="add-to-cart pull-left" href="product.html" style="margin-right: 10px"><i class="fa fa-shopping-cart"></i></a>
